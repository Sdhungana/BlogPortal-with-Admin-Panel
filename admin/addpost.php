...
<?php include 'inc/sidebar.php' ?>
    ...
    $query = "INSERT INTO tbl_post(cat,title,body,image,author,tags) VALUES('$cat','$title','$body','$unique_image','$author','$tags')";
                    ...
                    <table class="form">
                       ...
                       <!--  <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="author" placeholder="Enter AuthorName..." class="medium" />
                            </td>
                        </tr>
						<tr>
                            <td></td>
